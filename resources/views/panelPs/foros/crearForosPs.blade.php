        ...
        <div class="w-full bg-white p-5 bg-opacity-40 backdrop-filter backdrop-blur-lg rounded-3xl">
            <div class="w-12/12 mx-auto rounded-2xl bg-white p-1 bg-opacity-40 backdrop-filter backdrop-blur-lg">
                ...
                <form>
                    ...
                    <button type="submit" class="text-white bg-contenidocartas hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enviar</button>
                </form>

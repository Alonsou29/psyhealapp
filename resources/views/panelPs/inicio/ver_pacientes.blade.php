...
<div class="flex flex-col lg:flex-row justify-center lg:items-start">
  <div class="bg-gray-100 lg:mr-5">
    <div class="max-w-lg mx-auto my-10 bg-white rounded-lg shadow-md p-5">
      ...
      <div class="mt-5">
        <h3 class="text-xl text-center font-semibold mb-2">Biografía:</h3>
        <p class="text-gray-600 mt-2 text-justify">{{ $paciente->Biografia }}</p>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white shadow-md rounded-lg lg:w-[700px] max-w-[95%] mx-auto mt-5 p-3 lg:p-5">
    ...
    <div class="grid grid-cols-2 gap-4 px-2">
      <div class="flex flex-col items-start justify-center rounded-2xl bg-contenidocarta bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
        <p class="text-sm text-gray-600 font-bold">Teléfono</p>
        <p class="text-base font-bold text-navy-700 text-white">{{ $userPaciente->telefono }}</p>
      </div>
      ...
      <div class="flex flex-col justify-center rounded-2xl bg-contenidocarta bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
        <p class="text-sm text-gray-600 font-bold">Email</p>
        <p class="text-base font-bold text-navy-700 text-white">{{ $userPaciente->email }}</p>
      </div>

      <div class="flex flex-col items-start justify-center rounded-2xl bg-contenidocarta bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
        <p class="text-sm text-gray-600 font-bold">Fecha Nacimiento</p>
        <p class="text-base font-bold text-navy-700 text-white">{{ $userPaciente->birthdate }}</p>
      </div>

      <div class="flex flex-col justify-center rounded-2xl bg-contenidocarta bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
        <p class="text-sm text-gray-600 font-bold">Descripcion del Problema</p>
        <p class="text-base text-justify font-bold text-navy-700 text-white">{{ $paciente->descripcion_problema }}</p>
      </div>
    </div>
  </div>
</div>
